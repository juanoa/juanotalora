...
description: Internet prometía conectarnos, pero nos ha hecho más adictos, ansiosos y desconectados de lo real. Una reflexión sobre cómo las redes nos joden la vida.
publicationDate: 2025-09-03
---
import Image from "@/components/ui/Image.astro"
import Thumbnail from "./__assets__/redes-sociales-001.webp";
import AllSeen from "./__assets__/redes-sociales-002.webp";
import InstagramIsNotForFriends from "./__assets__/redes-sociales-003.webp";
import HundredHoursEating from "./__assets__/redes-sociales-004.webp";
import OnlyFans from "./__assets__/redes-sociales-005.webp";
import OnlyFansStats from "./__assets__/redes-sociales-006.webp";
...
<Image
  src={Thumbnail}
  alt="Ilustración de muchas personas usando su teléfono móvil"
/>
...
<Image
  src={AllSeen}
  alt="Mensaje de Instagram"
  caption="Mensaje de Instagram"
  width={500}
/>
...
<Image
  src={InstagramIsNotForFriends}
  alt="Artículo de Business Insider"
  caption="Fuente: Business Insider"
/>
...
<Image
  src={HundredHoursEating}
  alt="Captura de video de YouTube cone el título: 100 horas sin parar de comer en Japón"
  width={400}
/>
...
<Image
  src={OnlyFans}
  alt="OnlyFans como patrocinador en Moto2"
  caption="OnlyFans como patrocinador en Moto2"
  width={400}
/>
...
<Image
  src={OnlyFansStats}
  alt="El 10% de los creadores de OnlyFans ganan el 73% de los ingresos"
  caption="Estadísticas de ingresos de OF"
  width={600}
/>

Y mientras estos [creadores intentan adherirse](https://www.elespanol.com/reportajes/20250808/derecho-olvido-cecilia-sopena-profesora-ciclista-deja-onlyfans-nadie-deberia-llamarme-puta-digital/1003743878385_0.html) al cada vez más famoso “derecho al olvido”, su contenido sigue rodando por ahí, disponible para cualquiera que tenga un dispositivo con conexión a Internet. Accesible incluso para aquellos más jóvenes.
...
<div style={{display: "flex", justifyContent: "center", width: "100%", height: "315px"}}>
  <iframe width="560" height="315" src="https://www.youtube.com/embed/jbWHZwD5rGQ?si=ZYG4ML3tH5VACb1H" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
