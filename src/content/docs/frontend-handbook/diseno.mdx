...
![Diseño como una de las patas del Product Frontend Engineer](./__assets__/design-pillar.png)
...
![La solución correcta casi siempre suele estar en un lugar intermedio entre el *utilitas* y el *delectus*.](./__assets__/utilitas-delectus.png)
...
![De izquierda a derecha y de arriba a abajo: interfaz del primer Macintosh, SpaceJam, eBay y Flighty](./__assets__/interface-examples.png)
...
![Ejemplos de microinteracciones](./__assets__/micro-interactions.gif)
